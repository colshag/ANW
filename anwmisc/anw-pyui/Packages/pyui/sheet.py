...
class SheetEntry(pyui.widgets.Edit):
    ...
    def onKeyDown(self, event):
        ## TODO: remove this for now, make own subclass later if needed.
    ...
    def draw(self, renderer):
        ...
        for y in range(1, self.visibleRows):
            ...
            for x in range(1, self.visibleColumns):
                ...
                if value or value == 0:
                    renderer.drawText( "%s"%value, (self.windowRect[0]+posX+2, self.windowRect[1]+posY+3), pyui.colors.black)
