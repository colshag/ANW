...
class Ship(anwp.func.root.Root, anwp.sl.entity.Entity):
    ...
    def loadRegiment(self, regimentID):
        """Attempt to load a regiment into an available ship pod"""
    ...
    def removeMissile(self, gid):
        """Remove Missile object from dict"""
        try:
    ...
    def sacrificeRegiments(self):
        """Ship has taken pod damage which requires some Regiments to perish in battle
